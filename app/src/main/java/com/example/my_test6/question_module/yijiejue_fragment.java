...
public class yijiejue_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.question_view_yijiejue, container, false);

        final RefreshLayout refreshLayout = (RefreshLayout) root.findViewById(R.id.yijiejue_refreshlayout);
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                pageindex++;
                String url = "https://api.cnblogs.com/api/questions/@solved?pageIndex="
        ...
        recyclerView = (RecyclerView) root.findViewById(R.id.yijiejue_recyclerview);
        initdata();
    ...
    void initdata() {
        getApi = new GetApi();
        String url = "https://api.cnblogs.com/api/questions/@solved?pageIndex=1&pageSize=15";
