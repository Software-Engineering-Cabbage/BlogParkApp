...
public class guanzhu_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.question_view_guanzhu, container, false);
        setUI();
        return root;
    }
    ...
    private void setUI() {
        if (!TokenPool.getTokenPool().isLogin) {
            ...
            guanzhu_weidenglu_fragment f = new guanzhu_weidenglu_fragment();
            ft.replace(R.id.guanzhu_fragment,f);
            ft.commit();
            ...
            recyclerView = (RecyclerView) root.findViewById(R.id.guanzhu_recyclerview);
            initdata();
