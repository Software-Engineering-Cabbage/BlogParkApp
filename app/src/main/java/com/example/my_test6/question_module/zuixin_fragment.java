...
public class zuixin_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.question_view_zuixin, container, false);

        final RefreshLayout refreshLayout = (RefreshLayout) root.findViewById(R.id.zuixin_refreshlayout);
